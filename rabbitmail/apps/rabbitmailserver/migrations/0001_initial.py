# -*- coding: utf-8 -*-
# Generated by Django 1.9.13 on 2019-02-07 22:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mailbox_name', models.CharField(choices=[('INBOX', 'Inbox'), ('SENT_ITEMS', 'Sent Items'), ('DRAFT', 'Draft'), ('TRASH', 'Trash')], max_length=20, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='MailContent',
